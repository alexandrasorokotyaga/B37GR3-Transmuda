...
public class US39_VehicleSelectionStepDefs {
        ...
        // #1 Scenario. Both STORE & SALES managers are logged in
...
//#2 Scenario. STORE MANAGER log in
    ...
    public void userShouldSeeAllTheCheckboxesAsUnchecked() {
        vehicleSelectionPage.fleetModule.click();
        vehicleSelectionPage.vehiclesOption.click();
    }

    @Then("User should be able to check the first checkbox to select all the cars")
    public void userShouldBeAbleToCheckTheFirstCheckboxToSelectAllTheCars() {
    ...
    //#3 Scenario. SALES MANAGER log in
